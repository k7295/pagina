...
BEGIN
	...
	elseif (exists (select 1
        ...
        where (idIngrediente = new.idIngrediente) and (idCategoria = new.idCategoria)
        )) then
        signal	sqlstate '45000'
...
BEGIN
	if (not exists (select 1
		...
		begin
			...
			start transaction;
				insert into ingredientes(nombre, precioUnidad)
					values (p_nombre, p_precioUnidad);
                    
				set idObtenido = (select last_insert_id());
                
                insert into bitacora_cambios(fechaHora, idUsuario, detalles)
					select now(), p_idAdmin, concat("El administrador ", u.nombre, " agregó el ingrediente ",
						i.nombre, " al sistema.")
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_agregarIngredienteAInventario`(in p_idRestaurante int, in p_idIngrediente int, in p_cantidadDisponible decimal(13,3))
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_agregarIngredienteAPlatillo`(in p_idPlatillo int, in p_idIngrediente int, in p_cantidad decimal(10,3))
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_agregarPlatilloAMenuRestaurante`(in p_idRestaurante int, in p_idPlatillo int)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_agregarRestaurante`(in p_nombre nvarchar(50), in p_direccion nvarchar(200), 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_agregarUsuario`(in p_eMail nvarchar(50), in p_nombre nvarchar(50), in p_apellidos nvarchar(100), 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_agregarUsuarioAdministrador`(in p_eMail nvarchar(50), in p_nombre nvarchar(50), in p_apellidos nvarchar(100), 
     in p_password nvarchar(20), in p_idRestaurante int)
...
BEGIN
	...
	begin
		...
		start transaction;
			call sp_agregarUsuario(p_eMail, p_nombre, p_apellidos, p_password);
			set idGenerado = last_insert_id();	/* Obtiene el último valor de una columna auto-generada/identidad */ 
			call sp_asignarUsuarioAdministrador(idGenerado, p_idRestaurante);
		commit;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_agregarUsuarioCliente`(in p_eMail nvarchar(50), in p_nombre nvarchar(50), in p_apellidos nvarchar(100), 
     in p_password nvarchar(20), in p_numeroTelefono decimal(8,0))
...
BEGIN
	...
	begin
		...
		start transaction;
			...
			call sp_asignarUsuarioCliente(idGenerado, p_numeroTelefono);
		commit;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_asignarUsuarioAdministrador`(in p_idUsuario int, in p_idRestaurante int)
    COMMENT 'Asigna al usuario ingresado como administrador en un restaurante.'
BEGIN
	declare exit handler for sqlexception
		begin
			rollback;
	...
	start transaction;
		insert into usuarios_administradores(idUsuario, idRestaurante)
			values (p_idUsuario, p_idRestaurante);
    commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_asignarUsuarioCliente`(in p_idUsuario int, in p_numeroTelefono decimal(8,0))
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_borrarDetalleCarritoComprasClienteEnRestaurante`(in p_idCliente int, in p_idMenu int)
    COMMENT 'Borra un detalle del carrito de compra de un cliente.'
BEGIN
	declare exit handler for sqlexception
		begin
			rollback;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_borrarUsuario`(in p_idUsuario int)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_borrarUsuarioAdministrador`(in p_idAdministrador int)
    COMMENT 'Borra el administrador del sistema.'
BEGIN
	...
	elseif ((select count(*) from usuarios_administradores) = 1) then
		...
		call sp_borrarUsuario(p_idAdministrador);
    end if;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_borrarUsuarioCliente`(in p_idCliente int)
    COMMENT 'Borra el cliente del sistema.'
BEGIN
	if (not exists (select 1 from usuarios_clientes 
			where idUsuario = p_idCliente
		)) then
		...
		call sp_borrarUsuario(p_idCliente);
    end if;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_cambiarInventarioRestaurante`(in p_idRestaurante int, in p_idIngrediente int, in p_nuevaCantidad decimal(13,3))
...
BEGIN
	if ((p_fechaInicio is not null) and (p_fechaFin is not null) and
		...
		select b.id, date_format(b.fechaHora, '%d/%m/%Y %r') as 'fechaRegistro', b.idUsuario, 
			...
			where	(b.fechaHora >= coalesce(p_fechaInicio, b.fechaHora))
				and	(b.fechaHora <= coalesce(p_fechaFin, b.fechaHora));
    end if;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_getGananciasRestaurante_Dia` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=CURRENT_USER PROCEDURE `sp_getGananciasRestaurante_Dia`(in p_idFecha datetime(0))
BEGIN
	...
	elseif ((p_fechaInicio is not null) 
		...
		select vt.idOrden, vt.idRestaurante, vt.NombreRestaurante, 
			...
			where (i.id = p_idIngrediente)
				and (vt.idRestaurante = coalesce(p_idRestaurante, vt.idRestaurante))
                and (vt.fechaFactura >= coalesce(p_fechaInicio, vt.fechaFactura))
                and (vt.fechaFactura <= coalesce(p_fechaFin, (select current_date)));
    end if;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
	if ((p_fechaInicio is not null) 
		...
		select	idRestaurante, NombreRestaurante, 
			...
			where (vt.fechaFactura >= coalesce(p_fechaInicio, vt.fechaFactura))
				and (vt.fechaFactura <= coalesce(p_fechaFin, (select current_date)))
...
-- Dump completed on 2015-11-14 21:47:38
