...
--
-- Table structure for table `avenidas`
--
...
CREATE TABLE `avenidas` (
  ...
  `figura` LINESTRING           DEFAULT NULL,
  PRIMARY KEY (`id`)
)
  ENGINE = InnoDB
  AUTO_INCREMENT = 20
...
--
-- Dumping data for table `avenidas`
--

LOCK TABLES `avenidas` WRITE;
/*!40000 ALTER TABLE `avenidas` DISABLE KEYS */;
/*!40000 ALTER TABLE `avenidas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `cuadras`
--
...
--
-- Dumping data for table `cuadras`
--

LOCK TABLES `cuadras` WRITE;
/*!40000 ALTER TABLE `cuadras` DISABLE KEYS */;
/*!40000 ALTER TABLE `cuadras` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cuadras_restaurantes`
--

DROP TABLE IF EXISTS `cuadras_restaurantes`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cuadras_restaurantes` (
  ...
  KEY `FK_CaudRest_c_idx` (`idCuadra`),
  CONSTRAINT `FK_CaudRest_c` FOREIGN KEY (`idCuadra`) REFERENCES `cuadras` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK_CuadRest_r` FOREIGN KEY (`idRestaurante`) REFERENCES `restaurantes` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
--
-- Dumping data for table `cuadras_restaurantes`
--

LOCK TABLES `cuadras_restaurantes` WRITE;
/*!40000 ALTER TABLE `cuadras_restaurantes` DISABLE KEYS */;
/*!40000 ALTER TABLE `cuadras_restaurantes` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `sp_agregarRestaurante`(IN p_idAdmin   INT, IN p_nombre VARCHAR(50),
...
/*!50003 SET sql_mode = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `sp_borrarCarritoComprasClienteEnRestaurante`(IN p_idAdmin       INT,
                                                                                      IN p_idRestaurante INT,
                                                                                      IN p_idCliente     INT)
...
/*!50003 SET sql_mode = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `sp_borrarDetalleCarritoComprasClienteEnRestaurante`(IN p_idAdmin   INT,
                                                                                             IN p_idCliente INT,
                                                                                             IN p_idMenu    INT)
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `sp_getDistaciaRestaurantes` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8 */;
...
/*!50003 SET sql_mode = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `sp_getDistaciaRestaurantes`(IN p_idR1 INT, IN p_idR2 INT)
  BEGIN
    SELECT ST_distance(c1.figura, c2.figura)
    FROM
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `sp_getRestauranteAvenidas` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8 */;
...
/*!50003 SET sql_mode = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `sp_getRestauranteAvenidas`(IN `id` INT)
  BEGIN
    SELECT a.nombre AS Avenida
    FROM
      restaurantes
      INNER JOIN cuadras_restaurantes
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `sp_getRestauranteCalles` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8 */;
...
/*!50003 SET sql_mode = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `sp_getRestauranteCalles`(IN `id` INT)
  BEGIN
    SELECT c.nombre AS Calle
    FROM
      restaurantes
      INNER JOIN cuadras_restaurantes
        ON restaurantes.id = cuadras_restaurantes.idRestaurante
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `sp_getUbicacionRestaurante` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8 */;
...
/*!50003 SET sql_mode = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `sp_getUbicacionRestaurante`(IN `id` INT)
  BEGIN
    SELECT
      ST_X(ST_Centroid(cuadra.figura)) AS X,
      ST_Y(ST_Centroid(cuadra.figura)) AS Y
    FROM
      restaurantes
      INNER JOIN cuadras_restaurantes
        ON restaurantes.id = cuadras_restaurantes.idRestaurante
...
-- Dump completed on 2015-11-16  0:13:59
